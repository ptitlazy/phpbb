...
$lang = array_merge($lang, array(
	...
	'CLI_CONFIG_GET_OPTION'				=> 'Set this option if the value should be printed without a new line at the end.',
	'CLI_CONFIG_INCREMENT_ARGUMENT_2'	=> 'Amount to increment by.',
	'CLI_CONFIG_INCREMENT_OPTION'		=> 'Set this option if the configuration option changes too frequently to be efficiently cached.',
	'CLI_CONFIG_OPTION_NAME'			=> "The configuration option's name.",

	'CLI_CONFIG_SET_ARGUMENT_2'			=> 'New configuration value, use 0 and 1 to specify boolean values.',
	'CLI_CONFIG_SET_ATOMIC_ARGUMENT_2'	=> 'Current configuration value, use 0 and 1 to specify boolean values.',
	'CLI_CONFIG_SET_ATOMIC_ARGUMENT_3'	=> 'New configuration value, use 0 and 1 to specify boolean values.',
	'CLI_CONFIG_SET_ATOMIC_OPTION'		=> 'Set this option if the configuration option changes too frequently to be efficiently cached.',
	'CLI_CONFIG_SET_OPTION'				=> 'Set this option if the configuration option changes too frequently to be efficiently cached.',

	'CLI_CRON_RUN_ARGUMENT_1'	=> 'Name of the task to be run',

	'CLI_DESCRIPTION_CACHE_PURGE'			=> 'Vide le cache.',

	'CLI_DESCRIPTION_CONFIG_DB_MIGRATE'		=> 'Met à jour la base de données en appliquant les migrations.',
	'CLI_DESCRIPTION_CONFIG_DELETE'			=> 'Supprime une valeur de configuration.',
	'CLI_DESCRIPTION_CONFIG_GET'			=> "Retourne une valeur de configuration.",
	'CLI_DESCRIPTION_CONFIG_INCREMENT'		=> "Incrémente la valeur d'une option de configuration.",

	'CLI_DESCRIPTION_SEARCH_CREATE_INDEX'	=> 'Génère les index de recherche.',
	...
	'CLI_DESCRIPTION_CRON_LIST'				=> 'Affiche la liste des tâches cron (prêtes ou non).',
	'CLI_DESCRIPTION_CRON_RUN'				=> 'Exécute toutes les tâches cron prêtes.',
	'CLI_DESCRIPTION_CRON_RUN_ARGUMENT_1'	=> 'Name of the task to be run',
	'CLI_DESCRIPTION_CONFIG_SET'			=> "Définie la valeur d'une option de configuration.",
	'CLI_DESCRIPTION_CONFIG_SET_ATOMIC'		=> "Définie la valeur d'une option de configuration de façon atomique.",

	'CLI_DESCRIPTION_EXTENSION_DISABLE'				=> 'Désactive une extension.',
	'CLI_DESCRIPTION_EXTENSION_ENABLE'				=> 'Active une extension.',
	'CLI_DESCRIPTION_EXTENSION_PURGE'				=> 'Purge une extention.',
	'CLI_DESCRIPTION_EXTENSION_SHOW'				=> 'Liste l\'ensemble des extensions disponibles.',

	'CLI_DESCRIPTION_FIXUP_RECALCULATE_EMAIL_HASH'	=> 'Recalcule la colonne user_email_hash column de la table des utilisateurs.',

	'CLI_EXTENSION_NAME_ARGUMENT'		=> 'Name of the extension.',
	'CLI_DESCRIPTION_CRON_RUN_ARGUMENT_1'	=> 'Name of the task to be run',
	'CLI_DESCRIPTION_THUMBNAIL_DELETE'		=> 'Supprime toutes les miniatures.',
	'CLI_DESCRIPTION_THUMBNAIL_GENERATE'	=> 'Génère toutes les miniatures.',
	'CLI_DESCRIPTION_THUMBNAIL_RECREATE'	=> 'Regénère toutes les mniatures.',

	'CLI_DESCRIPTION_OPTION_SHELL'			=> 'Lance le shell.',

	'CLI_DESCRIPTION_USER_ADD'					=> 'Ajoute un utilisateur',
	...
	'CLI_DESCRIPTION_UPDATE_CHECK'		=> 'Vérifie si le forum est à jour.',
