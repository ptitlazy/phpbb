...
// Enable board rules notifications
				...
				$phpbb_notifications->enable_notifications('test');
...
// Disable board rules notifications
				$phpbb_notifications = $this->container->get('notification_manager');
				$phpbb_notifications->disable_notifications('test');
				return 'notifications';
		...
		switch ($old_state)
		{
			case '': // Empty means nothing has run yet
				...
				*/
				try
				{
					// Purge test rules notifications
					$phpbb_notifications = $this->container->get('notification_manager');
					$phpbb_notifications->purge_notifications('test');
				}
